...
Для первого случая (только рыночная борьба) математическая модель конкуренции двух фирм выглядит следующим образом:
...
Во втором случае (формирование общественного предпочтения) уравнения модифицируются:

$\frac{dM_1}{d\theta} = M_1 - (\frac{b}{c_1}+0.00042) M_1 M_2 - \frac{a_1}{c_1} M_1^2,$

$\frac{dM_2}{d\theta} = \frac{c_2}{c_1} M_2 - \frac{b}{c_1} M_1 M_2 - \frac{a_2}{c_1} M_2^2.$

Начальные условия: $M_1^0=7.9, M_2^0=9.9, p_{cr}=49, N=50, q=1, \tau_1=35, \tau_2=29, \tilde{p}_1=9.9, \tilde{p}_2=11.9$
